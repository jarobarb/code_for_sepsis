...
% IsoLineDemo    illustrate the use of the program IsoLine
%
% See also: IsoLine
...
H = IsoLine(Surf,R,T,'b');               % plot blue isolines
set(H(8),'Color','r')                    % red isoline at level R=1
axis equal, zoom(1.4)                    % figure settings
% -------------------------------------------------------------------------
...
shading interp
Surf = {x,y,z};                          % surface as cell array
h = IsoLine(Surf,D,[0 0]);               % zero contour of D
...
h = IsoLine(Surf,D,[0 0],'r');           % planar zero contour of H
set(h,'LineWidth',2)
